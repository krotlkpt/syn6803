...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "authorname/syn6803" ]]; then
...
echo "Your new report will be visible at https://authorname.github.io/syn6803 in a moment."
